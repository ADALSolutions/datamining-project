...
public class TfIdfTransformation {
  ...
  public static void main(String[] args) {
    ...
    String dataPath = "C:\\Users\\alvis\\Desktop\\Data Mining\\Progetto\\Dataset\\output-medium-sample\\output-medium-sample.bz2";

    // Usual setup
    SparkConf conf = new SparkConf(true).setAppName("Tf-Ifd transformation").setMaster("local");
