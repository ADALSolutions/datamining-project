...
insertions that must be applied to transform X into Y .
  ...
  */
   ...
   public static double calculateDistance(Vector a, Vector b) 
   {
	  ...
	  else if (distance.equals("standard")){
		  return Distance.standardDistance(a, b);
	  }
	  else if (distance.equals("manhattan")){
		  return Distance.manhattanDistance(a, b);
	  }
	  else if (distance.equals("jaccard")){
		  return Distance.jaccardDistance(a, b);
	  }
	  else if (distance.equals("hamming")){
		  return Distance.hammingDistance(a, b);
	  }
	  else if (distance.equals("edit")){
		  return Distance.editDistance(a, b);
	  }
      return Distance.standardDistance(a, b);
  }
