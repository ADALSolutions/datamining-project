...
public class TestAggiornati 
{
    ...
    public static void testIteratoConfrontoKMeansNormaleEuristicoAvanzato() throws FileNotFoundException, IOException, Exception 
    {
        ...
        while(j<tot)
        {
            ...
            S=ClusteringBuilder.kmeansPlusPlus(P, k);
            int i=0;
            while(i<length)
            {
        ...
        System.out.println("Cont KMeans: "+ClusteringBuilder.contMeans/(length*tot));
        System.out.println("Cont Euristico: "+ClusteringBuilder.contEuristico/(length*tot));
    ...
    public static Tuple4<Integer,Integer,Double,Double> testConfrontoKmeansNormaleEuristico(boolean init,ArrayList<Point> P, ArrayList<Point> S,int k) throws FileNotFoundException, IOException, Exception 
    {
        ...
        Clustering CNormale = ClusteringBuilder.kmeansAlgorithm_old(copyP,copyS , k);
        ...
        Clustering Ceuristic = ClusteringBuilder.kmeansEuristic_old(copyP,copyS, k);
        ...
        */
        Tuple4<Integer,Integer,Double,Double> t=new Tuple4((int)(end1-start1),(int)(end2-start2),Evaluation.AverageSilhouetteCoefficient(CNormale),Evaluation.AverageSilhouetteCoefficient(Ceuristic));//,CNormale.kmeans(),Ceuristic.kmeans()
        return t;
    }      
    //<tempoOld,tempoNuovo,QualOld,QualNuovo>
    public static Tuple4<Integer,Integer,Double,Double> testConfrontoKmeans(boolean init,ArrayList<Point> P, ArrayList<Point> S,int k) throws FileNotFoundException, IOException, Exception 
    {
        ...
        //Eseguo KMEANS VECCHIO(FACCIO UPDATE AL CLUSTERING)
        start2=System.currentTimeMillis();
        Clustering Cnuovo = ClusteringBuilder.kmeansAlgorithm_old(P, S, k);
        end2=System.currentTimeMillis();
